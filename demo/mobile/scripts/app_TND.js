...
function init_map() {
    var myOptions = {
        ...
        zoom: 16, center: new google.maps.LatLng(11.5340282, 107.78291119999994), mapTypeId: google.maps.MapTypeId.ROADMAP

    };
    var map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions),
    marker = new google.maps.Marker({ map: map, position: new google.maps.LatLng(11.5340282, 107.78291119999994) });
    infowindow = new google.maps.InfoWindow({ content: '<strong>Công ty TNHH thương mại và sản xuất Trà Ngọc Dung</strong><br>số 772/30, đường Trần Phú, phường Lộc Tiến, thành phố Bảo Lộc, tỉnh Lâm Đồng<br>' });
